<script lang="ts">
	...
	const HELP_TEXT = {
		link: 'https://github.com/oele-isis-vanderbilt/ChimeraPyOrchestrator/blob/main/chimerapy_orchestrator/models/pipeline_config.py',
		text: 'chimerapy_orchestrator.models.pipeline_models.pipeline_config.py'
	};
